...
class ReceiptPdfService {
     ...
     */
    static async generateReceiptPdf(transactionId) {
        ...
        const studentFeeSummary = await calculationService_1.CalculationService.getStudentFeeCalculation(transaction.studentId);
        ...
        // Color palette
        const primaryColor = (0, pdf_lib_1.rgb)(0.12, 0.22, 0.45); // Deep Navy
        const secondaryColor = (0, pdf_lib_1.rgb)(0.39, 0.40, 0.95); // Indigo
        const darkTextColor = (0, pdf_lib_1.rgb)(0.1, 0.15, 0.2);
        const lightTextColor = (0, pdf_lib_1.rgb)(0.45, 0.5, 0.58);
        const borderColor = (0, pdf_lib_1.rgb)(0.85, 0.88, 0.92);
        const cardBgColor = (0, pdf_lib_1.rgb)(0.97, 0.98, 1.0);
        const successColor = (0, pdf_lib_1.rgb)(0.06, 0.6, 0.35);
        const reversedColor = (0, pdf_lib_1.rgb)(0.88, 0.22, 0.22);
        let y = height - 50;
        ...
        page.drawRectangle({
            ...
            width: width - 90,
            height: 75,
            color: (0, pdf_lib_1.rgb)(0.99, 0.99, 1.0),
            borderColor: borderColor,
            borderWidth: 1,
        });
        ...
        page.drawRectangle({
            ...
            width: width - 90,
            height: 20,
            color: (0, pdf_lib_1.rgb)(0.92, 0.94, 0.98),
        });
        ...
        page.drawRectangle({
            ...
            width: 185,
            height: 65,
            color: (0, pdf_lib_1.rgb)(0.97, 0.98, 1.0),
            borderColor: borderColor,
            borderWidth: 1,
        });
        ...
        page.drawText(`Remaining Balance: ₹ ${pendingBalance.toLocaleString('en-IN', { minimumFractionDigits: 2 })}`, {
            ...
            size: 8.5,
            font: fontRegular,
            color: pendingBalance > 0 ? (0, pdf_lib_1.rgb)(0.8, 0.4, 0.1) : successColor,
        });
        y -= 95;
